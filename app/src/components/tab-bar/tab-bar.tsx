...
import TapBarButton from '@components/button/tap-bar-button';
...
export default function TabBar() {
  ...
  return (
    <div className="flex justify-between p-5 pt-0 gap-2.5 fixed bottom-0 left-0 right-0 z-10 bg-linear-to-t from-tg-secondary-bg-color/75 to-transparent">
